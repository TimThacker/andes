...
class IEEEG1MModel(TGBase):
    def __init__(self, system, config):
        ...
        self.wd = Algeb(info='Generator under speed',
                        ...
                        v_str='0',
                        e_str='ue * (uomega0 + wref - omega) - wd',
                        )
...
class IEEEG1M(IEEEG1MData, IEEEG1MModel):
    """
    ...
    M: Modified
    Modified such that the governor frequency reference can be updated
    """

    def __init__(self, system, config):
        IEEEG1MData.__init__(self)
        IEEEG1MModel.__init__(self, system, config)
